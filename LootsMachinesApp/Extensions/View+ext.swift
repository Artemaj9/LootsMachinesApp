...
extension View {
  ...
  func scrollMask(_ location1: Double = 0.09, _ location2: Double = 0.15, _ location3: Double = 0.9, _ location4: Double = 1) -> some View {
  ...
  func scrollMask(_ location2: Double = 0.15, _ location3: Double = 0.9) -> some View {
    self.modifier(ScrollMask(location1: 0, location2: location2, location3: location3, location4: 1.0))
  }
  
  func lootsFont(size: CGFloat, style: CustomFont, color: Color) -> some View {
    return self
